      ...
      <div class="news_cont">
        ...
        <div class="news_cont_right">
          ...
          <div class="news_cont_right_text">
            <div class="news_cont_right_text_item">
            ...
            <div class="news_cont_right_text_hr"></div>
            <div class="news_cont_right_text_item2">
              <h1>发展数字经济 共享包容增长 为经济发展插上“数字翅膀”</h1>
              <p>2021-05-30</p>
              <p>
                中国心理学会法律心理学分会副会长、中国人民公安大学教授李玫瑾，同时也担任
  ...
  data() {
    return {
      navList: [
        ...
        { title: "招聘详情", url: "/zhaopinxiangqing" },
        { title: "联系我们", url: "/lianxi" },
        { title: "招聘信息", url: "/zhaopin" },
      ],
